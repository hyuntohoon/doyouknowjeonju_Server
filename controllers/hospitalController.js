...
exports.getAllhospital10000000 = (fail, done) => {
  pool.getConnection((err, conn) => {
    ...
    let sql =
      "SELECT * FROM hospital WHERE hos_Subject LIKE '1%'";
    conn.query(sql, (err, rows) => {
      if (err) {
        return fail(err);
      }
...
exports.getAllhospital01000000 = (fail, done) => {
  pool.getConnection((err, conn) => {
    ...
    let sql =
      "SELECT * FROM hospital WHERE hos_Subject LIKE '_1%'";
    conn.query(sql, (err, rows) => {
      if (err) {
        return fail(err);
      }
...
exports.getAllhospital00100000 = (fail, done) => {
  pool.getConnection((err, conn) => {
    ...
    let sql =
      "SELECT * FROM hospital WHERE hos_Subject LIKE '__1%'";
    conn.query(sql, (err, rows) => {
      if (err) {
        return fail(err);
      }
...
exports.getAllhospital00010000 = (fail, done) => {
  pool.getConnection((err, conn) => {
    ...
    let sql =
      "SELECT * FROM hospital WHERE hos_Subject LIKE '___1%'";
    conn.query(sql, (err, rows) => {
      if (err) {
        return fail(err);
      }
...
exports.getAllhospital00001000 = (fail, done) => {
  pool.getConnection((err, conn) => {
    ...
    let sql =
      "SELECT * FROM hospital WHERE hos_Subject LIKE '____1%'";
    conn.query(sql, (err, rows) => {
      if (err) {
        return fail(err);
      }
...
exports.getAllhospital00000100 = (fail, done) => {
  pool.getConnection((err, conn) => {
    ...
    let sql =
      "SELECT * FROM hospital WHERE hos_Subject LIKE '_____1%'";
    conn.query(sql, (err, rows) => {
      if (err) {
        return fail(err);
      }
...
exports.getAllhospital00000010 = (fail, done) => {
  pool.getConnection((err, conn) => {
    ...
    let sql =
      "SELECT * FROM hospital WHERE hos_Subject LIKE '______1%'";
    conn.query(sql, (err, rows) => {
      if (err) {
        return fail(err);
      }
